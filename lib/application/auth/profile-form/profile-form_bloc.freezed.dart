...
class _$_ProfileFormState
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProfileFormState(username: $username, age: $age, height: $height, weight: $weight, password: $password, showErrorMessages: $showErrorMessages, isSubmitting: $isSubmitting, changingPassword: $changingPassword, editting: $editting, authFailureOrSuccessOption: $authFailureOrSuccessOption)';
  }
